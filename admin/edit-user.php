...
if (isset($_GET['id'])) {
    ...
    echo "<script>alert('ID User Belum Dipilih');document.location='manajemen-user.php'</script>";
}
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" placeholder="Email" name="email" required="" value="<?php echo $daftar['email']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="foto" placeholder="Ganti Foto" required="" name="foto" value="<?php echo $daftar['password']; ?>">
                                    </div>
...
if (isset($_POST['edit'])) {
    ...
    $edit = mysqli_query($conn, "UPDATE user set nm_user='$name', jenis_kelamin='$jk',  tgl_lahir='$tgllahir', alamat='$alamat', no_telp='$notelp', username='$user', password='$pass', level='$level', foto='$foto' where id_user='$id'");
    if ($edit) {
