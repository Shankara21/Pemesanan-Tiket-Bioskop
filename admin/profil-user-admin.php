                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="../img/foto/<?= $user1['foto']; ?>" alt="Admin" class="rounded-circle" width="150" height="150">
                                                    <div class="mt-3">
                                                        <h4><?= $user1['username']; ?></h4>
                                                        <p class="text-secondary mb-1"><?= $user1['level']; ?></p>

                                                        <a href="edit-user.php?id=<?php echo $user1['id_user']; ?>" class="btn btn-primary">Edit</a>
