...
<head>
    ...
    <title>GOMOVIE | Tambah Kategori</title>
...
if (isset($_POST['tambah'])) {
    ...
    $ktgr = $_POST['kategori'];
    $cek = mysqli_query($conn, "SELECT * FROM kategori where nm_kategori='$ktgr'");
    if (mysqli_num_rows($cek) > 0) {
        ...
        $save = mysqli_query($conn, "INSERT INTO kategori (nm_kategori) VALUES ('$ktgr')");
        if ($save) {
            echo "<script>alert('Kategori Berhasil Ditamabah'); document.location = 'manajemen-kategori.php';</script>";
        } else {
