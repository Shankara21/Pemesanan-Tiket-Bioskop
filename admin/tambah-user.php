...
<head>
    ...
    <title>GOMOVIE | Tambah User</title>
...
if (isset($_POST['tambah'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $save = mysqli_query($conn, "INSERT INTO user (nm_user,jenis_kelamin,email,tgl_lahir,alamat,no_telp,username,password,level) VALUES ('$name', '$jk', '$email', '$tgl_lahir', '$almt', '$no_telp', '$username','$pass','$level')");
        if ($save) {
